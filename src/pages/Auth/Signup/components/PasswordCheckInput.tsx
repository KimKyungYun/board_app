...
import PWCheckLogo from "assets/png/signup__password--check.png";
  ...
  return (
    <div className={styles.form__form}>
      ...
      <div className={styles.form__container}>
        <img src={PWCheckLogo} alt="" className={styles["form__logo"]} />
        <input
          ...
          {...register("passwordCheck", {
            ...
            validate: {
              checkPw: (v) =>
                v === watch("password") || ERROR_MESSAGE.passwordCheck,
            },
          })}
        />
      </div>
